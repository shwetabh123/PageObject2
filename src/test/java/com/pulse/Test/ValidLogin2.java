...
//@Listeners(generic.RealGuru99TimeReport.class)
	...
	public static	ITestResult result = null;
	   ...
	   //(description = "This test case verifies whether the reading check box is selected.")
	   ...
	   
	   {
		 ...
		 //  driver.navigate().to(appURL);
		   ...
		   Thread.sleep(10000);
			...
			b.typenew(driver,"typeyahoosearch","Yahoo");
	
		
			
		   
			 childTestnew.get().log(Status.INFO, "Typing in Yahoo search ");
			   

			   b.Click(driver,"typeyahoosearch");
				

				 childTestnew.get().log(Status.INFO, "Clicking in Yahoo search textbox ");
				  
			 
			 
			   b.Click(driver, "YahooSearch");
				
			   childTestnew.get().log(Status.INFO, "Clicking in Yahoo search button ");
